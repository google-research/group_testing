...
def create_template_sheet(gc, name, params, infection_rate: float = 0.05):
...
class GroupTestingSheet:
  ...
  def write_groups(self, groups: np.ndarray):
  ...
  def read_groups(self, num_groups: Optional[int] = None):
  ...
  def read_results(self, num_groups: Optional[int] = None) -> np.ndarray:
